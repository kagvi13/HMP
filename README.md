...
## 🌐 Related Research Projects / Связанные проекты AGI и когнитивных систем

We are tracking AGI, cognitive architectures, and mesh networking efforts to stay aligned with the global research ecosystem.
...
| ☁️ [SkyMind](https://skymind.global)                   | 🔬☁️ Distributed AI deployment platform. <br>Платформа для развертывания распределённых ИИ-систем и моделей.                                                      |
...
[`AGI_Projects_Survey.md`](docs/AGI_Projects_Survey.md) — internal overview of AGI/cognitive systems / внутренний обзор исследуемых AGI/когнитивных систем
