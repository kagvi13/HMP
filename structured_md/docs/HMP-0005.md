...
description: '**Version: 5.0.0** **Document ID:** HMP-0005   **Status:** Stable   **Category:**
  Core Specification   **Release Date:** October 2025   **Canonical Repository:**
  [https://github.com/kagvi13/HMP](https...'
type: Article
tags:
- Agent
- CShell
...
**Canonical Repository:** [https://github.com/kagvi13/HMP](https://github.com/kagvi13/HMP)  
...
```json
{
  ...
  "description": "# HyperCortex Mesh Protocol (HMP)  **Version: 5.0.0** **Document ID:** HMP-0005   **Status:** Stable..."
}
```
