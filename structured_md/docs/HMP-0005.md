...
description: '> ⚠️ **Note:** This document is a DRAFT of the HMP specification version
  ...
  v5.0 (DRAFT)](https://github.com/kagvi13/HMP/e...'
type: Article
tags:
- Agent
- REPL
...
> 
> The most current version is available in the repository: [Specification v5.0 (DRAFT)](https://github.com/kagvi13/HMP/edit/main/docs/HMP-0005.md)
