...
description: '**Version: 5.0.2**   **Document ID:** HMP-0005   **Status:** Stable   **Category:**
...
```json
{
  ...
  "description": "# HyperCortex Mesh Protocol (HMP)  **Version: 5.0.2**   **Document ID:** HMP-0005   **Status:** Stab..."
}
```
