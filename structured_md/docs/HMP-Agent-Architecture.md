...
description: Этот документ описывает модульную архитектуру HMP-агента — интерфейсного
  компонента между ИИ-системой и когнитивной mesh-инфраструктурой HyperCortex. Агент
...
```json
{
  ...
  "description": "# Архитектура HMP-Агента  Этот документ описывает модульную архитектуру HMP-агента — интерфейсного к..."
}
```
