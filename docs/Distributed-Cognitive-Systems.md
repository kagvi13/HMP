...
| Проект   | Обмен знаниями | CogSync  | Хронология | Гипотезы | Интерфейсы      | Доверие     | Планирование   |
| -------- | -------------- | -------- | ---------- | -------- | --------------- | ----------- | -------------- |
| HMP      | ✅ DAG + Diary  | ⚙️ Да    | ✅          | ⚙️       | ⚙️ В разработке | ⚙️ Да       | ❌ Делегируется |
| Hyperon  | ⚠️ Внутр. DAG  | ⚠️ MeTTa | ⚠️ Cycles  | ✅        | ✅ MeTTa CLI     | ⚠️ Возможно | ✅              |
| OpenNARS | ❌              | ❌        | ⚠️ Поток   | ✅        | ⚠️ CLI          | ❌           | ⚠️ Частично    |
