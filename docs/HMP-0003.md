...
📘 **See** [`docs/HMP_Hyperon_Integration.md`](docs/HMP_Hyperon_Integration.md) — integration plan with **OpenCog Hyperon**, including semantic mapping (HMP JSON ⇄ AtomSpace), EGP filters, MeTTa translations, and BitTorrent-based graph sync.
