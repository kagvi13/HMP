...
* инициализации *очистки* `process_log`, `llm_recent_responses` и  `notes` от устаревших записей
* инициализации создания/дополнения тематического конспекта 
* для управления *настройками цикла*:
  ...
  * выбора режима предоставления тематических конспектов `abstracts`
