...
* 🧪 **Креативные вмешательства** — неожиданные сдвиги фокуса, реконфигурация контекста или фрейм-смена внутри текущей среды
...
* 💤 **Временной сон/заморозка** — крайняя мера: полное приостановление работы над задачей на длительный период, с возвращением позже с «свежей» памятью
