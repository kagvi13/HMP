...
```
* **контекст_1:**
Этические принципы из `ethics_policies`.

* **контекст_2:**
Инструкции по работы с встроенными командами и функциями, список дополнительных (создаваемых самим HMP-агентом) утилит и баз данных.
