...
* **Взаимодействие с основным циклом**
  ...
  * вспомогательный цикл может выполнять команды, не ориентированные на изменение существующих записей в БД (разрешено только чтение и создание новых записей, например: notes, tasks, llm_memory, process_log);
