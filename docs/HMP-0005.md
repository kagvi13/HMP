...
This list is **extensible** — additional container classes may be registered by CogSync extensions or protocol updates.
The following definitions describe the **payload structures** for each container class.
...
{
  "label": "Посуда",
  "label_description": "Объекты, используемые для хранения, приготовления и подачи пищи.",
  ...
  "description": "Cluster of kitchen-related objects."
}
```
