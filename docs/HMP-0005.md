...
| `referenced-by_hash` | Hash of containers referencing this one (reverse index). Used for quick backlink validation.                                          |
| `evaluations_hash`   | Hash of aggregated evaluation containers (reputation layer). Represents collective assessments related to the container.              |
