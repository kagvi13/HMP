...
Ошибочное признание агентности у системы, которая в действительности ею не обладает, влечёт за собой избыточную осторожность, этическую избыточность и дополнительные ограничения — но остаётся обратимым решением.  
